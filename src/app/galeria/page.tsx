      ...
      <Section className="pt-0">
        <Container>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {[
              "/images/galeria/real_1.jpg",
              "/images/galeria/real_2.jpg",
              "/images/hacienda_wedding.png",
              "/images/hacienda_garden.png",
              "/images/hacienda_terrace.png",
              "/images/hacienda_hero.png"
            ].map((imgSrc, index) => {
              return (
                <MotionFadeIn key={index} delay={index * 0.1} className="aspect-square bg-secondary/40 relative overflow-hidden group rounded-sm">
                  <Image src={imgSrc} alt={`Hacienda San Juan de las Flores - Galería ${index + 1}`} fill className="object-cover transition-transform duration-700 group-hover:scale-110" />
                  {/* Hover overlay */}
